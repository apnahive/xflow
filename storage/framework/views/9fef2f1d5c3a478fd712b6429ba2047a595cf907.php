            ...
            <table class="table table-data2">
                <thead>
                    ...
                    <div class="search-task">
                        ...
                        <div class="col-md-4">
                            <input id="project" type="text" class="col-md-12" name="project" value="<?php echo e(old('project')); ?>" placeholder="Client" style="border: none;color: #808bab;box-shadow: 0px 10px 20px 0px rgba(0, 0, 0, 0.03);height: 40px;border-radius: 4px;font-weight: 600;font-size: 16px;">
                            <div class="rs-select2--light rs-select2--md" style="margin-top: 10px;width: 100%;font-weight: 600;font-size: 16px;">
                    ...
                    <tr>
                        ...
                        <th style="width: 148px;"><!-- <a href="<?php echo e(route('tasks.sort', ['name', 'asc'])); ?>"><i class="fas fa-sort-alpha-down"></i></a> --> Client<!--  <a href="<?php echo e(route('tasks.sort', ['name', 'desc'])); ?>"><i class="fas fa-sort-alpha-up"></i></a> --></th>
                        <th>Managed By</th>
                        <th>Assigned To</th>
                        <!-- <th>status</th>
                        <th>price</th> -->

            ...
            <table class="table table-data2">
                <thead>                    
                    <tr>
                        ...
                        <th><a href="<?php echo e(route('checklists.sort', ['title', 'asc'])); ?>"><i class="fas fa-sort-alpha-down"></i></a> Checklists <a href="<?php echo e(route('checklists.sort', ['title', 'desc'])); ?>"><i class="fas fa-sort-alpha-up"></i></a></th>
                        <th>Assigned To</th>
                        <th>Due Date</th>
                        <!-- <th>Managed By</th>
                        <th>Assigned To</th> -->
                            ...
                            <div class="table-data-feature">                                
                                ...
                                <div class="modal fade" id="assign<?php echo e($checklist->id); ?>" tabindex="-1" role="dialog" aria-labelledby="<?php echo e($checklist->id); ?>" aria-hidden="true">
                                  <div class="modal-dialog" role="document">
                                    <form action="<?php echo e(route('assign_checklist.store')); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <?php echo e(csrf_field()); ?>

                                    <input type="hidden" name="checklist_id" value="<?php echo e($checklist->id); ?>">

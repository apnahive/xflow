...
<div class="row" style="margin-bottom: 100px;">
    <div class="col-lg-12">
        <div class="card">
            ...
            <form action="<?php echo e(route('xflows.store')); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="card-body card-block">                    
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input id="startdate" type="date" class="form-control" name="startdate" value="<?php echo e(old('startdate')); ?>" required autofocus>

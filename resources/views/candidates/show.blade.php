            ...
            <div class="custom-tab">
                ...
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <a class="nav-item nav-link {{ old('tab') == 'custom-nav-sign-files' ? 'active' : '' }}" id="custom-nav-sign-files-tab" data-toggle="tab" href="#custom-nav-sign-files" role="tab" aria-controls="custom-nav-sign-files"
                    ...
                    <div class="tab-pane fade" id="custom-nav-sign-files" role="tabpanel" aria-labelledby="custom-nav-sign-files-tab">
                        <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    @foreach ($form_sign as $form_signkey => $sign_value)
                                        @if($sign_value->status)
                                        <a href="{{ route('profile.show', $sign_value['id']) }}" target="_blank">Download {{ $sign_value->name }} Signed Document</a><br>
                                        @endif
                                    @endforeach
                                    @endif
                                </div>

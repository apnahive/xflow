            ...
            <div class="custom-tab">
                ...
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <a class="nav-item nav-link <?php echo e(old('tab') == 'custom-nav-sign-files' ? 'active' : ''); ?>" id="custom-nav-sign-files-tab" data-toggle="tab" href="#custom-nav-sign-files" role="tab" aria-controls="custom-nav-sign-files"
                         aria-selected="false"><i class="fas fa-check-square"></i>Signed Files</a>
                ...
                <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="custom-nav-sign-files" role="tabpanel" aria-labelledby="custom-nav-sign-files-tab">
                        <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="summernote" class=" form-control-label">Signed files</label>
                                </div>
                                <div class="col-12 col-md-9">
                                    <?php if(count($form_sign) > 0): ?>
                                    <?php $__currentLoopData = $form_sign; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $form_signkey => $sign_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($sign_value->status): ?>
                                        <a href="<?php echo e(route('profile.show', $sign_value['id'])); ?>" target="_blank">Download <?php echo e($sign_value->name); ?> Signed Document</a><br>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                </div>

        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    <a href="<?php echo e(route('userroles.edit', $user->id)); ?>" class="btn btn-info pull-left" style="margin-right: 3px;">Edit</a>

                    <!-- <?php echo Form::open(['method' => 'DELETE', 'route' => ['userroles.destroy', $user->id] ]); ?>

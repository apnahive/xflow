        ...
        <div class="card">
            ...
            <div class="card-body card-block">                    
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input id="estimated_time_to_complete" type="time" class="form-control" name="estimated_time_to_complete" value="<?php echo e(old('estimated_time_to_complete')); ?>" required autofocus>
                        </div>

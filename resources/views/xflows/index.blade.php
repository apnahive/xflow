            ...
            <table class="table table-data2">
                <thead>                    
                    <tr>
                        ...
                        <th><a href="{{ route('xflows.sort', ['title', 'asc']) }}"><i class="fas fa-sort-alpha-down"></i></a> Title <a href="{{ route('xflows.sort', ['title', 'desc']) }}"><i class="fas fa-sort-alpha-up"></i></a></th>
                        <th>Assigned To</th>
                        <th>Team</th>
                        <th>Status</th>
                        <th>Timeline</th>

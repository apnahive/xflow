    ...
    <header>
      <!-- <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="width: 95%;margin: auto;">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url('{{ asset('assets/images/slider/h1.png') }}')">
            <div class="carousel-caption d-none d-md-block">
              <h4>This is the test.</h4>
              <p>This is the test.This is the test.This is the test.</p>
            </div>
          </div>
          <div class="carousel-item" style="background-image: url('{{ asset('assets/images/slider/h2.png') }}')">
            <div class="carousel-caption d-none d-md-block">
              <h4>This is the test.</h4>
              <p>This is the test.This is the test.This is the test.</p>
            </div>
          </div>
          <div class="carousel-item" style="background-image: url('{{ asset('assets/images/slider/h3.png') }}')">
            <div class="carousel-caption d-none d-md-block">
              <h4>This is the test.</h4>
              <p>This is the test.This is the test.This is the test.</p>
            </div>
          </div>
          <div class="carousel-item" style="background-image: url('{{ asset('assets/images/slider/h4.png') }}')">
            <div class="carousel-caption d-none d-md-block">
              <h4>This is the test.</h4>
              <p>This is the test.This is the test.This is the test.</p>
            </div>
          </div>
          <div class="carousel-item" style="background-image: url('{{ asset('assets/images/slider/h5.png') }}')">
            <div class="carousel-caption d-none d-md-block">
             <h4>This is the test.</h4>
              <p>This is the test.This is the test.This is the test.</p>
            </div>

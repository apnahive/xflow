        ...
        <div class="table-responsive table-responsive-data2">
            ...
            <div class="subject-info-box-2">
              <select multiple="true" id="lstBox2" name="assigned[]" class="form-control" >
                <?php $__currentLoopData = $cco_tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cco_taskkey => $cco_task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($cco_task->id); ?>"><?php echo e($cco_task->title); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                    
              </select>
            </div>
